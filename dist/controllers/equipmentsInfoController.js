...
exports.addEquipmentInfo = void 0;
const db_1 = require("../config/db");
const addEquipmentInfo = async (req, res) => {
    try {
        ...
        const { lab_equipment_list, applied_trades_equipment, library_books_list, amount_spent, } = req.body;
